...
export function LogBox({ content, className, heading }: LogBoxProps) {
  ...
  return (
    <div className={cn('min-w-0', className)}>
      ...
      <pre className='mono m-0 max-h-[240px] overflow-auto rounded-[var(--r-md)] border border-line bg-[color:var(--surface-2)] p-3 text-[11.5px] break-words whitespace-pre-wrap [overflow-wrap:anywhere]'>
        {displayed}
      </pre>
    </div>
  );
