  ...
  return (
    <div className='flex min-w-0 flex-wrap items-center gap-3 rounded-[var(--r-lg)] border border-[color:var(--success-line)] bg-[color:var(--success-soft)] p-4 shadow-[inset_3px_0_0_var(--success)]'>
      <div className='min-w-0 flex-1'>
        <p className='wrap-anywhere m-0 text-body font-semibold text-[color:var(--success)]'>
          실행을 시작했습니다
        </p>
        <p className='wrap-anywhere m-0 mt-1 flex flex-wrap items-center gap-2 text-body-sm text-fg-soft'>
